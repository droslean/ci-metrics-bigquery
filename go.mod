module github.com/droslean/ci-metrics-bigquery
...
require (
	...
	github.com/openshift/ci-tools v0.0.0-20251107142605-190ee630ffdd
...
require (
	...
	sigs.k8s.io/prow v0.0.0-20250903144316-f49c6158b87e // indirect
